...
def usage():
    ...
    print("\n This application will capture a 'fast motion' video clip. More specificaly, over the capture period\n"
          ...
          "    Usage: python3 fastMotionVideo.py [-t capture_duration] [-d decimation] [-f playback_framerate] capture_names\n"
          "       where:\n"
    ...
    print("          capture_names         Names used for the captured files. The video will have\n"
          "                                a '.avi' extension.\n")
    print("    Example:")
    print("        python3 fastMotionVideo.py -t 30 cap")
...
"""
Keyboard input will be passed to the application with the user pressing
the enter key.
